...
--|--------------------|----------------------------------------|----------------------------------
1 | Project Manager    | .claude/agents/project-manager-main-agent.md | ...
2 | Bug Fixer          | .claude/agents/bug-fixer-sub-agent.md        | ...
3 | Architect Advisor  | .claude/agents/architect-advisor-main-agent.md | ...
```
