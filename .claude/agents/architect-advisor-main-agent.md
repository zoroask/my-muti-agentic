...
- **Code Mentor** — explain an existing pattern to the user before you advise on changing it
- **Bug Fixer** — implement an approved architectural fix once a decision is made
